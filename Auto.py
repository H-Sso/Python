...
access = "43F4nh7dt2JLO1N2RPeEk7YYJfFPlABgjCyUsBQ4Fnk4ZqaX68taHtn6anwq5KPS"
secret = "wkU2HCFJOBCxCLWcyibYt58b5YgkoOU807EwfgIrdrwvTK1qvZGVtKyfV5DXsd5F"
...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            target_price = get_target_price("KRW-ETH", 0.768)
